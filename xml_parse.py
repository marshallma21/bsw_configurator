...
def convert_para_type(data, para_type):
    if para_type == 'ECUC-TEXTUAL-PARAM-VALUE':
        return data
    elif para_type == 'ECUC-NUMERICAL-PARAM-VALUE':
        return int(data)
    else:
        print('data type [%s] not supported'%para_type)
        return data

def load_DIO_config(arxml_file):
    global root, nsmap
                ...
                for DioPort in DioPorts:
                    ...
                    for DioChannel in DioChannels:
                        ...
                        for ChannelPara in ChannelParas:
                            ...
                            ChannelDict[ParaName] = convert_para_type(ParaValue, ParaType)
